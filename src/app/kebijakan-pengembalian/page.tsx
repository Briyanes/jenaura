    ...
    <main>
      <section className="bg-gradient-to-br from-jena-mocha to-jena-charcoal pb-12 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8 relative header-pt-page">
          <h1 className="font-display text-4xl sm:text-5xl text-white font-bold mb-2">Kebijakan Pengembalian</h1>
        ...
        <div className="max-w-3xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-4">
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-jena-peach/50">
              ...
              <p className="text-base text-jena-charcoal/60 leading-relaxed">Kami yakin kamu akan mencintai JENAURA. Jika kamu tidak puas dengan produk yang diterima, kami menawarkan garansi pengembalian 100% dalam 7 hari setelah penerimaan.</p>
            </div>
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-jena-peach/50">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2.5 text-base text-jena-charcoal/60">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-jena-peach/50">
              ...
              <p className="text-base text-jena-charcoal/60 leading-relaxed">Pengembalian tidak berlaku untuk produk yang sudah digunakan lebih dari 3x, rusak karena kelalaian pembeli, atau dibeli lebih dari 30 hari yang lalu.</p>
            </div>
          </div>
        </div>
      </section>
